...
{
	public class AccidentCarsPage : PageBase
	{
		protected override string ControllerName { get; } = "AccidentCars";
        protected override string PageTitle => "Accident Cars";

        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.AccidentCarsLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("AccidentCarUniqueNameMessage")));
