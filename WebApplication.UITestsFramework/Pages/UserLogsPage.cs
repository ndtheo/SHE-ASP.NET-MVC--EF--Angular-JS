...
{
	public class UserLogsPage : PageBase
	{
		protected override string ControllerName { get; } = "UserLogs";
        protected override string PageTitle => "User Logs";
        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.UserLogsLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("UserLogUniqueNameMessage")));
