...
{
	public class ColorsPage : PageBase
	{
		protected override string ControllerName { get; } = "Colors";
        protected override string PageTitle { get; } = "Colors";
        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.ColorsLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("ColorUniqueNameMessage")));
