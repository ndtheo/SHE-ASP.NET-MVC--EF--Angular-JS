...
{
	public class AccidentPhotoesPage : PageBase
	{
		protected override string ControllerName { get; } = "AccidentPhotoes";
        protected override string PageTitle => "Accident Photos";

        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.AccidentPhotoesLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("AccidentPhotoUniqueNameMessage")));
