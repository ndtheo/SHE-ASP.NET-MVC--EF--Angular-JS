...
{
	public class RepairShopsPage : PageBase
	{
		protected override string ControllerName { get; } = "RepairShops";
        protected override string PageTitle => "Repair Shops";
        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.RepairShopsLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("RepairShopUniqueNameMessage")));
