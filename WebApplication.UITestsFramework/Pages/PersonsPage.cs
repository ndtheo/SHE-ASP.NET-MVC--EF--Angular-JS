...
{
	public class PeoplePage : PageBase
	{
		protected override string ControllerName { get; } = "People";
        protected override string PageTitle => "People";
        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.PeopleLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("PersonUniqueNameMessage")));
