...
{
	public class CarBrandsPage : PageBase
	{
		protected override string ControllerName { get; } = "CarBrands";
        protected override string PageTitle => "Car Brands";
        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.CarBrandsLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("CarBrandUniqueNameMessage")));
