...
{
	public class CarsPage : PageBase
	{
		protected override string ControllerName { get; } = "Cars";
        protected override string PageTitle => "Cars";
        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.CarsLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("CarUniqueNameMessage")));
