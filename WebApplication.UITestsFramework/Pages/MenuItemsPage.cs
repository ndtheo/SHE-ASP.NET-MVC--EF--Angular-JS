...
{
	public class MenuItemsPage : PageBase
	{
		protected override string ControllerName { get; } = "MenuItems";
		protected override string PageTitle { get; } = "Menu Items";

		public override void Goto()
		{
			Pages.TopNavigation.AdministrationDropdown.Click();
			Thread.Sleep(200);
			Pages.TopNavigation.MenuItemsLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("MenuItemUniqueNameMessage")));
