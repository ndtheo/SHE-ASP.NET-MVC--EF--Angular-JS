...
{
	public class CarModelsPage : PageBase
	{
		protected override string ControllerName { get; } = "CarModels";
        protected override string PageTitle => "Car Models";

        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.CarModelsLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("CarModelUniqueNameMessage")));
