...
{
	public class ActivitiesPage : PageBase
	{
		protected override string ControllerName { get; } = "Activities";
        ...
        public override void Goto()
		{
			...
			Thread.Sleep(200);
			Pages.TopNavigation.ActivitiesLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("ActivityUniqueNameMessage")));
