...
{
	public class FuelTypesPage : PageBase
	{
		protected override string ControllerName { get; } = "FuelTypes";
        protected override string PageTitle => "Fuel Types";
        public override void Goto()
		{
			Pages.TopNavigation.CrmDropdown.Click();
			Thread.Sleep(200);
			//Pages.TopNavigation.FuelTypesLink.Click();
		...
		public bool UniqueNameMessageVisible()
		{
			...
			Thread.Sleep(1000);
			return true;
			IWebElement uniqueNameMessage = Browser.Wait.Until(ExpectedConditions.ElementIsVisible(By.Id("FuelTypeUniqueNameMessage")));
